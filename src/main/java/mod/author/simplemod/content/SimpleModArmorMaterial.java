...
public enum SimpleModArmorMaterial implements IArmorMaterial
{
    FOO ("simplemod:foo", 8, new int [] {1,2,3,2}, 8,
            SoundEvents.ITEM_ARMOR_EQUIP_CHAIN , 0.0F,
            ()-> { return Ingredient.fromItems(ModItems.foo_ingot.get());} ),
    BAR ("simplemod:bar", 9, new int [] {1,2,3,2}, 8,
         SoundEvents.ITEM_ARMOR_EQUIP_CHAIN , 0.0F,
            ()-> { return Ingredient.fromItems(ModItems.bar_ingot.get());} );
    ...
    private SimpleModArmorMaterial(String nameIn, int maxDamageIn, int[] drAmtArray,
