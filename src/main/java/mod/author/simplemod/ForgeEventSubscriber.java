 ...
 *
 */
@EventBusSubscriber(modid = SimpleMod.MODID, bus = EventBusSubscriber.Bus.FORGE)
public final class ForgeEventSubscriber
{
        @SuppressWarnings("unused")
        private static final Logger LOGGER = LogManager.getLogger(SimpleMod.MODID + " Forge Event Subscriber");
